...
function GameCard({ game, featured = false }: { game: any; featured?: boolean }) {
  return (
    ...
    >
      ...
      >
        {/* Top gradient bar */}
        <div className={`h-2 w-full bg-gradient-to-r ${game.color}`}></div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-muted/20">
      ...
      <section className="py-16 container mx-auto px-4">
        <div className="bg-gradient-to-br from-blue-500/10 via-purple-500/5 to-pink-500/10 backdrop-blur-sm border border-border/50 rounded-xl p-8 md:p-12">
